...
class Config
{
	...
	const FORM_FIELD_COUNTRY_NAME                                       = "FormFieldCountryName";
	...
	const FORM_FIELD_ROLE_DESCRIPTION                                   = "FormFieldRoleDescription";
	const FORM_FIELD_ROLE_NAME                                          = "FormFieldRoleName";
	...
	const FORM_NOTIFICATION_VIEW_UPDATE                                 = "FormNotificationViewUpdate";
	const FORM_NOTIFICATION_VIEW_UPDATE_SUBMIT                          = "FormNotificationViewUpdateSubmit";
	const FORM_ROLE                                                     = "FormRole";
	const FORM_ROLE_LIST                                                = "FormRoleList";
	const FORM_ROLE_LIST_BACK                                           = "FormRoleListBack";
	const FORM_ROLE_LIST_FORM                                           = "FormRoleListForm";
	const FORM_ROLE_LIST_FORWARD                                        = "FormRoleListForward";
	const FORM_ROLE_REGISTER                                            = "FormRoleRegister";
	const FORM_ROLE_REGISTER_CANCEL                                     = "FormRoleRegisterCancel";
	const FORM_ROLE_REGISTER_FORM                                       = "FormRoleRegisterForm";
	const FORM_ROLE_REGISTER_SUBMIT                                     = "FormRoleRegisterSubmit";
	const FORM_ROLE_RETURN_NOT_FOUND                                    = "FormRoleNotFound";
	const FORM_ROLE_SELECT                                              = "FormRoleSelect";
	const FORM_ROLE_SELECT_FORM                                         = "FormRoleSelectForm";
	const FORM_ROLE_SELECT_SUBMIT                                       = "FormRoleSelectSubmit";
	const FORM_ROLE_UPDATE_FORM                                         = "FormRoleUpdateForm";
	const FORM_ROLE_UPDATE_CANCEL                                       = "FormRoleUpdateCancel";
	const FORM_ROLE_UPDATE_SUBMIT                                       = "FormRoleUpdateSubmit";
	const FORM_ROLE_VIEW                                                = "FormRoleView";
	const FORM_ROLE_VIEW_DELETE                                         = "FormRoleViewDelete";
	const FORM_ROLE_VIEW_DELETE_SUBMIT                                  = "FormRoleViewDeleteSubmit";
	const FORM_ROLE_VIEW_LIST_USERS                                     = "FormRoleViewListUsers";
	const FORM_ROLE_VIEW_LIST_USERS_FORM                                = "FormRoleViewListUsersForm";
	const FORM_ROLE_VIEW_LIST_USERS_SUBMIT                              = "FormRoleViewListUsersSubmit";
	const FORM_ROLE_VIEW_LIST_USERS_SUBMIT_BACK                         = "FormRoleViewListUsersSubmitBack";
	const FORM_ROLE_VIEW_LIST_USERS_SUBMIT_FORWARD                      = "FormRoleViewListUsersSubmitForward";
	const FORM_ROLE_VIEW_UPDATE                                         = "FormRoleViewUpdate";
	const FORM_ROLE_VIEW_UPDATE_SUBMIT                                  = "FormRoleViewUpdateSubmit";
	...
	const PAGE_ADMIN_ROLE_LIST                                          = "Page_Admin_Role_List";
	const PAGE_ADMIN_ROLE_REGISTER                                      = "Page_Admin_Role_Register";
	const PAGE_ADMIN_ROLE_SELECT                                        = "Page_Admin_Role_Select";
	const PAGE_ADMIN_ROLE_UPDATE                                        = "Page_Admin_Role_Update";
	...
	const TABLE_USER_FIELD_USER_BIRTH_DATE                              = "BirthDate";
	const TABLE_USER_FIELD_USER_CONFIRMED                               = "UserConfirmed";
	const TABLE_USER_FIELD_USER_CORPORATION                             = "Corporation";
	const TABLE_USER_FIELD_USER_COUNTRY                                 = "Country";
	const TABLE_USER_FIELD_USER_EMAIL                                   = "Email";
	const TABLE_USER_FIELD_USER_GENDER                                  = "Gender";
	const TABLE_USER_FIELD_USER_HASH_CODE                               = "HashCode";
	const TABLE_USER_FIELD_USER_NAME                                    = "Name";
	const TABLE_USER_FIELD_USER_PASSWORD                                = "Password";
	...
	const TABLE_USER_FIELD_USER_REGION                                  = "Region";
	const TABLE_USER_FIELD_USER_SESSION_EXPIRES                         = "SessionExpires";
	const TABLE_USER_FIELD_USER_TWO_STEP_VERIFICATION                   = "TwoStepVerification";
