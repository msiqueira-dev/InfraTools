...
class Config
{
	...
	const FORM_SYSTEM_CONFIGURATION_LIST_SELECT_SUBMIT                  = "FormSystemConfigurationListSelectSubmit";
	const FORM_SYSTEM_CONFIGURATION_REGISTER                            = "FormSystemConfigurationReturnRegister";
	const FORM_SYSTEM_CONFIGURATION_REGISTER_CANCEL                     = "FormSystemConfigurationReturnCancel";
	const FORM_SYSTEM_CONFIGURATION_REGISTER_SUBMIT                     = "FormSystemConfigurationReturnSubmit";
