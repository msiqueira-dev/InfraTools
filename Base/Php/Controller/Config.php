...
class Config
{
	...
	const FORM_SYSTEM_CONFIGURATION_LIST                                = "FormSystemConfigurationListForm";
	const FORM_SYSTEM_CONFIGURATION_LIST_FORM                           = "FormSystemConfigurationList";
	const FORM_SYSTEM_CONFIGURATION_LIST_FORM_BACK                      = "FormSystemConfigurationListFormBack";
	const FORM_SYSTEM_CONFIGURATION_LIST_FORM_FORWARD                   = "FormSystemConfigurationListFormForward";
	const FORM_SYSTEM_CONFIGURATION_LIST_FORM_SELECT_SUBMIT             = "FormSystemConfigurationListFormSelectSubmit";
	...
	const FORM_SYSTEM_CONFIGURATION_REGISTER_FORM_CANCEL                = "FormSystemConfigurationRegisterFormCancel";
	const FORM_SYSTEM_CONFIGURATION_REGISTER_FORM_SUBMIT                = "FormSystemConfigurationRegisterFormSubmit";
	...
	const FORM_SYSTEM_CONFIGURATION_SELECT_FORM_SUBMIT                  = "FormSystemConfigurationSelectFormSubmit";
	const FORM_SYSTEM_CONFIGURATION_UPDATE                              = "FormSystemConfigurationUpdate";	
	const FORM_SYSTEM_CONFIGURATION_UPDATE_FORM                         = "FormSystemConfigurationUpdateForm";
	const FORM_SYSTEM_CONFIGURATION_UPDATE_FORM_CANCEL                  = "FormSystemConfigurationUpdateFormCancel";
	const FORM_SYSTEM_CONFIGURATION_UPDATE_FORM_SUBMIT                  = "FormSystemConfigurationUpdateFormSubmit";
	const FORM_SYSTEM_CONFIGURATION_VIEW                                = "FormSystemConfigurationView";
	const FORM_SYSTEM_CONFIGURATION_VIEW_FORM                           = "FormSystemConfigurationViewForm";
	const FORM_SYSTEM_CONFIGURATION_VIEW_FORM_DELETE                    = "FormSystemConfigurationViewFormDelete";
	const FORM_SYSTEM_CONFIGURATION_VIEW_FORM_DELETE_SUBMIT             = "FormSystemConfigurationViewFormDeleteSubmit";
	const FORM_SYSTEM_CONFIGURATION_VIEW_FORM_UPDATE                    = "FormSystemConfigurationViewFormUpdate";
	const FORM_SYSTEM_CONFIGURATION_VIEW_FORM_UPDATE_SUBMIT             = "FormSystemConfigurationViewFormUpdateSubmit";
