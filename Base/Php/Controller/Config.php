...
class Config
{
	...
	const EXCEPTION_TYPE_USER_ID                                        = "ExceptionTypeUserId";
	...
	const FORM_FIELD_SYSTEM_CONFIGURATION_OPTION_ACTIVE                 = "FormFieldSystemConfigurationActive";
	const FORM_FIELD_SYSTEM_CONFIGURATION_OPTION_DESCRIPTION            = "FormFieldSystemConfigurationDescription";
	const FORM_FIELD_SYSTEM_CONFIGURATION_OPTION_NAME                   = "FormFieldSystemConfigurationName";
	const FORM_FIELD_SYSTEM_CONFIGURATION_OPTION_NUMBER                 = "FormFieldSystemConfigurationNumber";
	const FORM_FIELD_SYSTEM_CONFIGURATION_OPTION_VALUE                  = "FormFieldSystemConfigurationValue";
