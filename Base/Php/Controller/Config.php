...
class Config
{
	...
	const EXCEPTION_USER_UNIQUE_ID                                      = "ExceptionUserUniqueId";
	...
	const FORM_TYPE_TICKET_VIEW_LIST_USERS_BACK                         = "FormTypeTicketViewListUsersBack";
	const FORM_TYPE_TICKET_VIEW_LIST_USERS_FORM                         = "FormTypeTicketViewListUsersForm";
	const FORM_TYPE_TICKET_VIEW_LIST_USERS_FORWARD                      = "FormTypeTicketViewListUsersForward";
