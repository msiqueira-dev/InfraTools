...
class Config
{
	...
	const FORM_NOTIFICATION                                             = "FormSystemConfiguration";
	const FORM_NOTIFICATION_LIST                                        = "FormSystemConfigurationListForm";
	const FORM_NOTIFICATION_LIST_FORM                                   = "FormSystemConfigurationList";
	const FORM_NOTIFICATION_LIST_FORM_BACK                              = "FormSystemConfigurationListFormBack";
	const FORM_NOTIFICATION_LIST_FORM_FORWARD                           = "FormSystemConfigurationListFormForward";
	const FORM_NOTIFICATION_LIST_FORM_SELECT_SUBMIT                     = "FormSystemConfigurationListFormSelectSubmit";
	const FORM_NOTIFICATION_REGISTER                                    = "FormSystemConfigurationRegister";
	const FORM_NOTIFICATION_REGISTER_FORM                               = "FormSystemConfigurationRegisterForm";
	const FORM_NOTIFICATION_REGISTER_FORM_CANCEL                        = "FormSystemConfigurationRegisterFormCancel";
	const FORM_NOTIFICATION_REGISTER_FORM_SUBMIT                        = "FormSystemConfigurationRegisterFormSubmit";
	const FORM_NOTIFICATION_RETURN_NOT_FOUND                            = "FormSystemConfigurationNotFound";
	const FORM_NOTIFICATION_SELECT                                      = "FormSystemConfigurationSelect";
	const FORM_NOTIFICATION_SELECT_FORM                                 = "FormSystemConfigurationSelectForm";
	const FORM_NOTIFICATION_SELECT_FORM_SUBMIT                          = "FormSystemConfigurationSelectFormSubmit";
	const FORM_NOTIFICATION_UPDATE                                      = "FormSystemConfigurationUpdate";	
	const FORM_NOTIFICATION_UPDATE_FORM                                 = "FormSystemConfigurationUpdateForm";
	const FORM_NOTIFICATION_UPDATE_FORM_CANCEL                          = "FormSystemConfigurationUpdateFormCancel";
	const FORM_NOTIFICATION_UPDATE_FORM_SUBMIT                          = "FormSystemConfigurationUpdateFormSubmit";
	const FORM_NOTIFICATION_VIEW                                        = "FormSystemConfigurationView";
	const FORM_NOTIFICATION_VIEW_FORM                                   = "FormSystemConfigurationViewForm";
	const FORM_NOTIFICATION_VIEW_FORM_DELETE                            = "FormSystemConfigurationViewFormDelete";
	const FORM_NOTIFICATION_VIEW_FORM_DELETE_SUBMIT                     = "FormSystemConfigurationViewFormDeleteSubmit";
	const FORM_NOTIFICATION_VIEW_FORM_UPDATE                            = "FormSystemConfigurationViewFormUpdate";
	const FORM_NOTIFICATION_VIEW_FORM_UPDATE_SUBMIT                     = "FormSystemConfigurationViewFormUpdateSubmit";
