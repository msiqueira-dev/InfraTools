...
<div class="DivBody">
    <div class="DivContentBody">
				...
				<div class="DivContentBodyOptionsBox">
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_SERVICE_SELECT; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_SERVICE_REGISTER; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_SERVICE_LIST; ?>"
		...
		//PAGE_ADMIN_SERVICE_VIEW_LIST_USERS
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_SERVICE_VIEW_LIST_USERS)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_SERVICE_VIEW_LIST_USERS)) . ".php");
		}
