...
<div class="DivBody">
    <div class="DivContentBody">
    	<form name="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET; ?>" 
			  id="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET; ?>" method="post" >
			<!-- SUBMIT -->
			<div class="DivContentBodyOptions">
				<div class="DivContentBodyOptionsBox">
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_SELECT; ?>"
							   value="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_SELECT; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_REGISTER; ?>"
							   value="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_REGISTER; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_LIST; ?>"
							   value="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_LIST; ?>"
		...
		<?php 
		//LIST
		if($this->Page == ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_LIST)
		{
		...
		//REGISTER
		elseif($this->Page == ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_REGISTER)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
		...
		//SELECT
		elseif($this->Page == ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_SELECT)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_SELECT)) . ".php");
		}
		//UPDATE
		elseif($this->Page == ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_UPDATE)
		{
			 include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						  str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_UPDATE))                                            . ".php");
		}
		//VIEW
		elseif($this->Page == ConfigInfraTools::PAGE_ADMIN_TYPE_STATUS_TICKET_VIEW)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
