				...
				<div class="DivContentBodyOptionsBox">
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_SELECT; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_REGISTER; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_TYPE_STATUS_TICKET_LIST; ?>"
