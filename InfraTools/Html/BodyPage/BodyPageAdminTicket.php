<!-- BODY_PAGE_ADMIN_TICKET -->
<div class="DivBody">
    <div class="DivContentBody">
    	<form name="<?php echo ConfigInfraTools::FM_TICKET; ?>" 
			  id="<?php echo ConfigInfraTools::FM_TICKET; ?>" method="post" >
			<!-- SUBMIT -->
			<div class="DivContentBodyOptions">
				<div class="DivContentBodyOptionsBox">
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FM_TICKET_SEL; ?>"
							   id="<?php echo ConfigInfraTools::FM_TICKET_SEL; ?>"
							   value="<?php echo ConfigInfraTools::FM_TICKET_SEL; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FM_TICKET_REGISTER; ?>"
							   id="<?php echo ConfigInfraTools::FM_TICKET_REGISTER; ?>"
							   value="<?php echo ConfigInfraTools::FM_TICKET_REGISTER; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FM_TICKET_LST; ?>"
							   id="<?php echo ConfigInfraTools::FM_TICKET_LST; ?>"
							   value="<?php echo ConfigInfraTools::FM_TICKET_LST; ?>"
		...
		//PAGE_ADMIN_TICKET_LST
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TICKET_LST)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TICKET_LST)) . ".php");
		}
		//PAGE_ADMIN_TICKET_REGISTER
		...
		//PAGE_ADMIN_TICKET_SEL
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TICKET_SEL)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TICKET_SEL)) . ".php");
		}
		//PAGE_ADMIN_TICKET_UPDT
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TICKET_UPDT)
		{
			 include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						  str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TICKET_UPDT)) . ".php");
		}
		//PAGE_ADMIN_TICKET_VIEW
