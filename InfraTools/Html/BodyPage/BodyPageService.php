...
<div class="DivBody">
    <div class="DivContentBody">
    	<div class="DivContentBodySecondTitle">
			<img src="{$ICON_INFRATOOLS_SERVICE}" alt="IconInfraToolsSearch" class="DivContentBodySecondTitleImage" width="136" height="96"/>
		</div>
		<div class="DivContentBodySecondTitleLine"></div>
		<div class="DivContentBodyOptions">
			<div class="DivContentBodyOptionsBox">
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_SEL}" title="{$HREF_PAGE_SERVICE_SEL}">
				...
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_REGISTER}" title="{$HREF_PAGE_SERVICE_REGISTER}">
						<div class="DivContentBodyContainersBoxIcon">
				...
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_ASSOCIATE_IP_ADDRESS}" title="{$HREF_PAGE_SERVICE_ASSOCIATE_IP_ADDRESS}">
						...
						<div class="DivContentBodyContainersBoxText">
							<i>
								{$PAGE_SERVICE_ASSOCIATE_IP_ADDRESS}
							</i>
						</div>
					</a>
				</div>
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_LST}" title="{$HREF_PAGE_SERVICE_LST}">
						<div class="DivContentBodyContainersBoxIcon">
				...
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_LST_BY_CORPORATION}" title="{$HREF_PAGE_SERVICE_LST_BY_CORPORATION}">
						<div class="DivContentBodyContainersBoxIcon">
						...
						<div class="DivContentBodyContainersBoxText">
							<i>
								{$PAGE_SERVICE_LST_BY_CORPORATION}
							</i>
						</div>
					</a>
				</div>
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_LST_BY_DEPARTMENT}" title="{$HREF_PAGE_SERVICE_LST_BY_DEPARTMENT}">
						<div class="DivContentBodyContainersBoxIcon">
						...
						<div class="DivContentBodyContainersBoxText">
							<i>
								{$PAGE_SERVICE_LST_BY_DEPARTMENT}
							</i>
						</div>
					</a>
				</div>
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_LST_BY_TYPE_ASSOC_USER_SERVICE}" title="{$HREF_PAGE_SERVICE_LST_BY_TYPE_ASSOC_USER_SERVICE}">
						<div class="DivContentBodyContainersBoxIcon">
						...
						<div class="DivContentBodyContainersBoxText">
							<i>
								{$PAGE_SERVICE_LST_BY_TYPE_ASSOC_USER_SERVICE}
							</i>
						</div>
					</a>
				</div>
				<div class="DivContentBodyContainersBox">
					<a href="{$HREF_PAGE_SERVICE_LST_BY_TYPE_SERVICE}" title="{$HREF_PAGE_SERVICE_LST_BY_TYPE_SERVICE}">
						...
						<div class="DivContentBodyContainersBoxText">
							<i>
								{$PAGE_SERVICE_LST_BY_TYPE_SERVICE}
							</i>
						</div>
					</a>
				</div>
