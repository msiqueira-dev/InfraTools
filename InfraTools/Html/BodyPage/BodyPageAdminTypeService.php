...
<form name="{$FM_TYPE_SERVICE}" 
			id="{$FM_TYPE_SERVICE}" method="post" >
	<!-- SUBMIT -->
	<div class="DivContentBodyOptions">
		<div class="DivContentBodyOptionsBox">
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_TYPE_SERVICE_SEL}" id="{$FM_TYPE_SERVICE_SEL}" value="{$FM_TYPE_SERVICE_SEL}"
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_TYPE_SERVICE_REGISTER}" id="{$FM_TYPE_SERVICE_REGISTER}" value="{$FM_TYPE_SERVICE_REGISTER}"
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_TYPE_SERVICE_LST}" id="{$FM_TYPE_SERVICE_LST}" value="{$FM_TYPE_SERVICE_LST}"
