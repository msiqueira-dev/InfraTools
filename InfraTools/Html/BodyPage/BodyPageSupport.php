    ...
    <div class="DivContentBody">
		...
		<div class="DivContentBodyOptions">
			<div class="DivContentBodyOptionsBox">
				...
				<div class="DivContentBodyContainersBox">
					<a href="<?php echo $this->InstanceLanguageText->GetText('HREF_PAGE_SUPPORT_REGISTER'); ?>" 
					  title="<?php echo $this->InstanceLanguageText->GetText('HREF_PAGE_SUPPORT_REGISTER') ?>">
						<div class="DivContentBodyContainersBoxIcon">
				...
				<div class="DivContentBodyContainersBox">
					<a href="<?php echo $this->InstanceLanguageText->GetText('HREF_PAGE_SUPPORT_LST'); ?>" 
					  title="<?php echo $this->InstanceLanguageText->GetText('HREF_PAGE_SUPPORT_LST') ?>">
						<div class="DivContentBodyContainersBoxIcon">
