...
<div class="DivBody">
    <div class="DivContentBody">
    	<div class="DivContentBodySecondTitle">
			<img src="<?php echo $this->Config->DefaultServerImage. 'Logos/LogoInfraTools-1020x127WhiteBackground.png'; ?>" 
				 alt="IconInfraToolsSearch" class="DivContentBodySecondTitleImage" width="1020" height="127"/>
		</div>
		<div class="DivContentBodySecondTitleLine"></div>
		<div class="DivContentBodyContainers">
			<a href="https://github.com/msiqueira-dev/InfraTools" target="_blank" 
					  title="GIT HUB - INFRATOOLS">
