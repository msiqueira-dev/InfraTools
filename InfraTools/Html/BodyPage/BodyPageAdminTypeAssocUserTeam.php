...
<div class="DivBody">
    <div class="DivContentBody">
    	<form name="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM; ?>" 
			  id="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM; ?>" method="post" >
			<!-- SUBMIT -->
			<div class="DivContentBodyOptions">
				<div class="DivContentBodyOptionsBox">
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_SEL; ?>"
							   id="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_SEL; ?>"
							   value="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_SEL; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_REGISTER; ?>"
							   id="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_REGISTER; ?>"
							   value="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_REGISTER; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   name="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_LST; ?>"
							   id="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_LST; ?>"
							   value="<?php echo ConfigInfraTools::FM_TYPE_ASSOC_USER_TEAM_LST; ?>"
		...
		//PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_LST
		if($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_LST)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_LST)) . ".php");
		}
		//PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_VIEW_LST_USERS
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_VIEW_LST_USERS)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", 
													  ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_VIEW_LST_USERS)) . ".php");
		}
		//PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_REGISTER
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_REGISTER)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_REGISTER)) . ".php");
		}
		//PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_SEL
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_SEL)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						 str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_SEL)) . ".php");
		}
		//PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_UPDT
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_UPDT)
		{
			 include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
						  str_replace("PageAdmin", "", str_replace("_", "", ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_UPDT)) . ".php");
		}
		//PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_VIEW
		elseif($this->PageBody == ConfigInfraTools::PAGE_ADMIN_TYPE_ASSOC_USER_TEAM_VIEW)
		{
			include_once(REL_PATH . ConfigInfraTools::PATH_FORM . 
