        ...
        <div id="tabs" class="ui-tabs ui-widget ui-widget-content ui-tabs-vertical">
            <ul id="tabsUl" class="ui-tabs-nav ui-widget-header">
                ...
                <li id="tabsLi-1" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_AVAILABILITY; ?>#tabs1" 
                ...
                <li id="tabsLi-2" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_BLACKLIST ?>#tabs2" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>" 
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-3" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_DNS_RECORD ?>#tabs3" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-4" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_EMAIL_EXISTS ?>#tabs4" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-5" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_IP_ADDRESS_IS_IN_NETWORK ?>#tabs5" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-6" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_PING_SERVER ?>#tabs6" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-7" class="ui-state-default <?php echo $functionClass; ?>">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_CHECK_PORT_STATUS ?>#tabs7" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-8" class="ui-state-default">
                	<a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_CALCULATION_NETMASK ?>#tabs8" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-9" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_DNS_RECORDS ?>#tabs9" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-10" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_HOSTNAME ?>#tabs10" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-11" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_IP_ADDRESSES ?>#tabs11" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-12" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_LOCATION ?>#tabs12" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-13" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_PROTOCOL ?>#tabs13" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-14" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_ROUTE ?>#tabs14" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-15" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_SERVICE ?>#tabs15" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-16" class="ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_WEBSITE ?>#tabs16" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                        <?php echo $functionId; ?>>
                ...
                <li id="tabsLi-17" class="NoBorder ui-state-default">
                    <a href="PageDiagnosticTools?=<?php echo ConfigInfraTools::PAGE_GET_WHOIS ?>#tabs17" 
                       class="ui-tabs-anchor <?php echo $functionClass; ?>"
                       <?php echo $functionId; ?>>
