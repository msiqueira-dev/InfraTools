...
<div class="DivContentBodyOptions">
	<div class="DivContentBodyOptionsBox">
		...
		<div class="DivContentBodyContainersBox">
			<a href="{$HREF_PAGE_SERVICE_REGISTER}" 
				title="{$HREF_PAGE_SERVICE_REGISTER}">
				<div class="DivContentBodyContainersBoxIcon">
		...
		<div class="DivContentBodyContainersBox">
			<a href="{$HREF_PAGE_SERVICE_LST}" 
				title="{$HREF_PAGE_SERVICE_LST}">
				<div class="DivContentBodyContainersBoxIcon">
		...
		<div class="DivContentBodyContainersBox">
			<a href="{$HREF_PAGE_SERVICE_LST_BY_DEPARTMENT}" 
				title="{$HREF_PAGE_SERVICE_LST_BY_DEPARTMENT}">
				<div class="DivContentBodyContainersBoxIcon">
		...
		<div class="DivContentBodyContainersBox">
			<a href="{$HREF_PAGE_SERVICE_LST_BY_TYPE_SERVICE}" 
				title="{$HREF_PAGE_SERVICE_LST_BY_TYPE_SERVICE}">
				<div class="DivContentBodyContainersBoxIcon">
