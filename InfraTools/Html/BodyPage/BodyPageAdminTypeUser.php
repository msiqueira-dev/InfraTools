...
<form name="{$FM_TYPE_USER}" 
	...
	<div class="DivContentBodyOptions">
		<div class="DivContentBodyOptionsBox">
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_TYPE_USER_SEL}" id="{$FM_TYPE_USER_SEL}" value="{$FM_TYPE_USER_SEL}"
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_TYPE_USER_REGISTER}" id="{$FM_TYPE_USER_REGISTER}" value="{$FM_TYPE_USER_REGISTER}"
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_TYPE_USER_LST}" id="{$FM_TYPE_USER_LST}" value="{$FM_TYPE_USER_LST}"
