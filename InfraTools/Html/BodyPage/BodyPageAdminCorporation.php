...
<form name="{$FM_CORPORATION}" id="{$FM_CORPORATION}" method="{$FORM_METHOD}" >
	<!-- SUBMIT -->
	<div class="DivContentBodyOptions">
		<div class="DivContentBodyOptionsBox">
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_CORPORATION_SEL}" id="{$FM_CORPORATION_SEL}" value="{$FM_CORPORATION_SEL}"
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_CORPORATION_REGISTER}" id="{$FM_CORPORATION_REGISTER}" value="{$FM_CORPORATION_REGISTER}"
			...
			<div class="DivContentBodyContainersBox">
				<input type="image" name="{$FM_CORPORATION_LST}" id="{$FM_CORPORATION_LST}" value="{$FM_CORPORATION_LST}"
