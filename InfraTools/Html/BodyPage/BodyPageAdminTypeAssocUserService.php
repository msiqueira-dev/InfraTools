				...
				<div class="DivContentBodyOptionsBox">
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_TYPE_ASSOC_USER_SERVICE_SELECT; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_TYPE_ASSOC_USER_SERVICE_REGISTER; ?>"
					...
					<div class="DivContentBodyContainersBox">
						<input type="image" 
							   ...
							   id="<?php echo ConfigInfraTools::FORM_TYPE_ASSOC_USER_SERVICE_LIST; ?>"
