                ...
                <div class="DivContentBodyContainersBoxBackground">
                    ...
                    <div class="DivContentBodyContainersBoxText">
                        <div class="DivContentBodyContainersBoxText1">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_CHECK_1'); ?> 
                            </label>
                        </div>
                        <div class="DivContentBodyContainersBoxText2">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_CHECK_2'); ?> 
                            </label>
                        </div>
                        <div class="DivContentBodyContainersBoxText3">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_CHECK_3'); ?> 
                            </label>
                        </div>
                    </div>
            ...
            <div class="DivContentBodyContainersBox">
                <div class="DivContentBodyContainersBoxBackground">
                    ...
                    <div class="DivContentBodyContainersBoxText">
                        <div class="DivContentBodyContainersBoxText1">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_GET_1'); ?>
                            </label>
                        </div>
                        <div class="DivContentBodyContainersBoxText2">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_GET_2'); ?>
                            </label>
                        </div>
                        <div class="DivContentBodyContainersBoxText3">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_GET_3'); ?>
                            </label>
                        </div>
                    </div>
                    <div class="DivContentBodyContainersBoxLink">
            ...
            <div class="DivContentBodyContainersBox">
                <div class="DivContentBodyContainersBoxBackground">
                    ...
                    <div class="DivContentBodyContainersBoxText">
                        <div class="DivContentBodyContainersBoxText1">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_CLOUD_1'); ?>
                            </label>
                        </div>
                        <div class="DivContentBodyContainersBoxText2">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_CLOUD_2'); ?>
                            </label>
                        </div>
                        <div class="DivContentBodyContainersBoxText3">
                            <label>
                                <?php echo $this->InstanceLanguageText->GetText('HOME_CLOUD_3'); ?>
                            </label>
                        </div>
                    </div>
                    <div class="DivContentBodyContainersBoxLink">
...
<div class="DivContentBodyCertification">
    <div class="DivContentBodyCertificationTitle">
        <h3>
            <?php echo $this->InstanceLanguageText->GetText('HOME_CERTIFICATION'); ?> 
        </h3>
        <div class="DivContentBodyCertificationTitleLine">
        </div>
    </div>
    <div class="DivContentBodyCertificationImages">
