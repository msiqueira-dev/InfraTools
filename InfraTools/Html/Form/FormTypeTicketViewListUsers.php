...
if(is_array($this->ArrayInstanceUser))
{
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FORM_TYPE_TICKET_VIEW_LIST_USERS_SUBMIT_BACK . "' 
				  id='"    . ConfigInfraTools::FORM_TYPE_TICKET_VIEW_LIST_USERS_SUBMIT_BACK . "'
				  value='" . ConfigInfraTools::FORM_TYPE_TICKET_VIEW_LIST_USERS_SUBMIT_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FORM_TYPE_TICKET_VIEW_LIST_USERS_SUBMIT_FORWARD . "' 
				  id='"    . ConfigInfraTools::FORM_TYPE_TICKET_VIEW_LIST_USERS_SUBMIT_FORWARD . "'
				  value='" . ConfigInfraTools::FORM_TYPE_TICKET_VIEW_LIST_USERS_SUBMIT_FORWARD . "'
