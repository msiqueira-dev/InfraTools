...
{
	echo "<form  name='" . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_FORM . "' method='post' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_SB_BACK . "' 
				  id='"    . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_SB_BACK . "'
				  value='" . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_SB_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_SB_FORWARD . "' 
				  id='"    . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_SB_FORWARD . "'
				  value='" . ConfigInfraTools::FM_DEPARTMENT_VIEW_LST_USERS_SB_FORWARD . "'
				  title='" . $this->InstanceLanguageText->GetText('SUBMIT_FORWARD') . "'
				  alt='"   . $this->InstanceLanguageText->GetText('SUBMIT_FORWARD') . "'
				  src='"   . $this->Config->DefaultServerImage 
						   . "Icons/IconInfraToolsArrowForward28x28.png'
				  onmouseover=\"this.src='" . $this->Config->DefaultServerImage
						   . "Icons/IconInfraToolsArrowForwardHover28x28.png'\"
				  onmouseout=\"this.src='"  . $this->Config->DefaultServerImage
