...
<!-- FM_TYPE_STATUS_TICKET_REGISTER_FORM -->
<form name="<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_FORM; ?>" 
      id="<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_FORM; ?>" method="post">
        ...
        <div class="DivContentBodyContainerValue">
            <input type="text" name="<?php echo ConfigInfraTools::FIELD_TYPE_STATUS_TICKET_DESCRIPTION; ?>" 
                               ...
                               onblur="ValidateDescription(null, 
                                                 ...
                                                 '<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_SB; ?>',
                                                 '', true);
                                       ValidateMultiplyFields(
                                                 '<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_FORM; ?>',
                                                 'DivContentBodySubmitBigger ',
                                                 '<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_SB; ?>',
                                                 '');"
    ...
    <div class="DivContentBodyContainer"
         onmouseover="ValidateDescription(null, '<?php echo ConfigInfraTools::FIELD_TYPE_STATUS_TICKET_DESCRIPTION; ?>',
                      ...
                      ValidateMultiplyFields(
                                   ...
                                   '<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_SB; ?>',
                                   '');">
        <input type="submit" name="<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_SB; ?>" 
                                 id="<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_SB; ?>"
                                 class="DivContentBodySubmitBigger <?php echo $this->SubmitClass ?>"
                                 value="<?php echo $this->InstanceLanguageText->GetText('SUBMIT_REGISTER'); ?>"
                                 <?php echo $this->SubmitEnabled; ?> />
        <input type="submit" name="<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_CANCEL; ?>" 
                                 id="<?php echo ConfigInfraTools::FM_TYPE_STATUS_TICKET_REGISTER_CANCEL; ?>"
