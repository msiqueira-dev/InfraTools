...
{
	echo "<form  name='" . ConfigInfraTools::FORM_TYPE_TICKET_LIST_FORM . "' method='post' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 ...
		 "<div class='TableGenericThLeft'>"    . $this->InstanceLanguageText->GetText('FORM_FIELD_TYPE_TICKET_DESCRIPTION') . "</div></th>";
	echo "<th  class= 'TableGenericThArrow'> 
