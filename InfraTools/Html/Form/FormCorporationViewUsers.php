...
{
	echo "<form  name='" . ConfigInfraTools::FM_CORPORATION_VIEW_LST_USERS_FORM . "' method='post' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FM_CORPORATION_LST_VIEW_USERS_BACK . "' 
				  id='"    . ConfigInfraTools::FM_CORPORATION_LST_VIEW_USERS_BACK . "'
				  value='" . ConfigInfraTools::FM_CORPORATION_LST_VIEW_USERS_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FM_CORPORATION_LST_VIEW_USERS_FORWARD . "' 
				  id='"    . ConfigInfraTools::FM_CORPORATION_LST_VIEW_USERS_FORWARD . "'
				  value='" . ConfigInfraTools::FM_CORPORATION_LST_VIEW_USERS_FORWARD . "'
