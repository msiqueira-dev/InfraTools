<!-- FM_CORPORATION_VIEW_LST_USERS_FORM -->
...
<table class='TableGeneric'>
	<tr>
		<form  name="{$FM_CORPORATION_VIEW_LST_USERS_FORM}" method="{$FORM_METHOD}">
			<th class="TableGenericThArrow">
				<div class="TableGenericInputLeft">
					<input  type="image" class="TableGenericThArrowImage"
							name="{$FM_CORPORATION_VIEW_LST_USERS_SB_BACK}" id="{$FM_CORPORATION_VIEW_LST_USERS_SB_BACK}" 
							value="{$FM_CORPORATION_VIEW_LST_USERS_SB_BACK}" title="{$SUBMIT_BACK}" alt="{$SUBMIT_BACK}"
			...
			<th  class="TableGenericThArrow">
				...
				<div class="TableGenericInputRight">
					<input  type="image" class="TableGenericThArrowImage"
							name="{$FM_CORPORATION_VIEW_LST_USERS_SB_FORWARD}" id="{$FM_CORPORATION_VIEW_LST_USERS_SB_FORWARD}" 
							value="{$FM_CORPORATION_VIEW_LST_USERS_SB_FORWARD}" title="{$SUBMIT_FORWARD}" alt="{$SUBMIT_FORWARD}"
