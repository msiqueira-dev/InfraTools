...
<form name="{$FM_NOTIFICATION_UPDT_FORM}" id="{$FM_NOTIFICATION_UPDT_FORM}" method="{$FORM_METHOD}">
    ...
    <div class="DivContentBodyContainer"
         onmouseover="ValidateDescription('DivContentBodyContainerValueTextArea', '{$FIELD_NOTIFICATION_TEXT}','DivContentBodySubmitBigger',
								          '{$FM_NOTIFICATION_UPDT_SB}', '', true);
                      ValidateMultiplyFields('{$FM_NOTIFICATION_UPDT_FORM}', 'DivContentBodySubmitBigger',
                                             '{$FM_NOTIFICATION_UPDT_SB}', '');">
        <input type="submit" name="{$FM_NOTIFICATION_UPDT_SB}" id="{$FM_NOTIFICATION_UPDT_SB}"
               class="DivContentBodySubmitBigger {$SUBMIT_CLASS}"
               value="{$SUBMIT_UPDT}" {$SUBMIT_ENABLED} />
        <input type="submit" name="{$FM_NOTIFICATION_UPDT_CANCEL}" id="{$FM_NOTIFICATION_UPDT_CANCEL}"
