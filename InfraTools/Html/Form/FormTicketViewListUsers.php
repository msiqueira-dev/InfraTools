...
if(is_array($this->ArrayInstanceUser))
{
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FORM_TICKET_VIEW_LIST_USERS_SUBMIT_BACK . "' 
				  id='"    . ConfigInfraTools::FORM_TICKET_VIEW_LIST_USERS_SUBMIT_BACK . "'
				  value='" . ConfigInfraTools::FORM_TICKET_VIEW_LIST_USERS_SUBMIT_BACK . "'
		 ...
		 "<div class='TableGenericThRight'>" . $this->InstanceLanguageText->GetText('FORM_FIELD_TICKET_ID') . "</div></th>";
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FORM_TICKET_VIEW_LIST_USERS_SUBMIT_FORWARD . "' 
				  id='"    . ConfigInfraTools::FORM_TICKET_VIEW_LIST_USERS_SUBMIT_FORWARD . "'
				  value='" . ConfigInfraTools::FORM_TICKET_VIEW_LIST_USERS_SUBMIT_FORWARD . "'
		...
		echo "<td class='TableGenericTdLink'>
					<form  name='" . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "' method='post' />
						...
						<input type='submit' name='" . ConfigInfraTools::FORM_FIELD_TICKET_ID . "' 
										 ...
										 value='" . $this->InstanceTicket->GetTicketId() . "' 
										 title='" . $this->InstanceTicket->GetTicketId() . "' />
						</form>
				  </td>";
		echo "<td class='TableGenericTdLink'>
