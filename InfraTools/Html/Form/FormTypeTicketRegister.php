...
<!-- FORM_TYPE_TICKET_REGISTER_FORM -->
<form name="<?php echo ConfigInfraTools::FORM_TYPE_TICKET_REGISTER_FORM; ?>" 
      id="<?php echo ConfigInfraTools::FORM_TYPE_TICKET_REGISTER_FORM; ?>" method="post">
            ...
            <input type="text" name="<?php echo ConfigInfraTools::FORM_FIELD_TYPE_TICKET_DESCRIPTION; ?>" 
                               ...
                               onblur="ValidateDescription(null, 
                                       ...
                                       ValidateMultiplyFields(
                                                 '<?php echo ConfigInfraTools::FORM_TYPE_TICKET_REGISTER_FORM; ?>',
                                                 'DivContentBodySubmitBigger ',
                                                 '<?php echo ConfigInfraTools::FORM_TYPE_TICKET_REGISTER_SUBMIT; ?>',
                                                 '');"
