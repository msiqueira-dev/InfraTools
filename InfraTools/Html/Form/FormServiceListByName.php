...
if(is_array($this->ArrayInstanceInfraToolsService) && (count($this->ArrayInstanceInfraToolsService)>0))
{
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_BACK . "' 
				  id='"    . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_BACK . "'
				  value='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_FORWARD . "' 
				  id='"    . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_FORWARD . "'
				  value='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_FORWARD . "'
		...
		echo "<td class='TableGenericTdLink'>
			  	<form  name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_SELECT_BY_NAME_AND_ID . "' method='post' />
			    	<input type='hidden' name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_SELECT_BY_ID_SUBMIT . "' 
		      		...
		      		<input type='submit' name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_SELECT_BY_NAME_AND_ID_SUBMIT . "' 
		                           id='"   . ConfigInfraTools::FORM_SERVICE_LIST_BY_NAME_SELECT_BY_NAME_AND_ID_SUBMIT . "' 
