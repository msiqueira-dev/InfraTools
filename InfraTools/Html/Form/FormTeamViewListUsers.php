...
<!-- FM_TEAM_VIEW_LST_USERS_FORM -->
<?php
if(is_array($this->ArrayInstanceInfraToolsUser))
{
	echo "<form  name='" . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_FORM . "' method='post' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_SB_BACK . "' 
				  id='"    . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_SB_BACK . "'
				  value='" . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_SB_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_SB_FORWARD . "' 
				  id='"    . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_SB_FORWARD . "'
				  value='" . ConfigInfraTools::FM_TEAM_VIEW_LST_USERS_SB_FORWARD . "'
