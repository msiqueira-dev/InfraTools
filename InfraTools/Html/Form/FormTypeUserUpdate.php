    ...
    <div class="DivContentBodyContainer"
         onmouseover="ValidateDescription(null, '<?php echo ConfigInfraTools::FORM_FIELD_TYPE_USER_DESCRIPTION; ?>',
                      ...
                      ValidateMultiplyFields(
                                   ...
                                   '<?php echo ConfigInfraTools::FORM_TYPE_USER_UPDATE_SUBMIT; ?>',
                                   '');">
        <input type="submit" name="<?php echo ConfigInfraTools::FORM_TYPE_USER_UPDATE_SUBMIT; ?>" 
                                 id="<?php echo ConfigInfraTools::FORM_TYPE_USER_UPDATE_SUBMIT; ?>"
                                 class="DivContentBodySubmitBigger <?php echo $this->SubmitClass ?>"
                                 value="<?php echo $this->InstanceLanguageText->GetText('SUBMIT_UPDATE'); ?>"
                                 <?php echo $this->SubmitEnabled; ?> />
        <input type="submit" name="<?php echo ConfigInfraTools::FORM_TYPE_USER_UPDATE_CANCEL; ?>" 
                                 id="<?php echo ConfigInfraTools::FORM_TYPE_USER_UPDATE_CANCEL; ?>"
