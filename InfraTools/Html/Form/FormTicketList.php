...
{
	echo "<form  name='" . ConfigInfraTools::FORM_TICKET_LIST_FORM . "' method='post' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FORM_TICKET_LIST_BACK . "' 
				  id='"    . ConfigInfraTools::FORM_TICKET_LIST_BACK . "'
				  value='" . ConfigInfraTools::FORM_TICKET_LIST_BACK . "'
		 ...
		 "<div class='TableGenericThLeft'>"    . $this->InstanceLanguageText->GetText('FORM_FIELD_TICKET_ID') . "</div></th>";
	echo "<th  class='TableGenericThDiv'>"     . $this->InstanceLanguageText->GetText('FORM_FIELD_TICKET_TITLE') . "</th>";
	echo "<th  class='TableGenericThDiv'>"     . $this->InstanceLanguageText->GetText('FORM_FIELD_TICKET_TYPE') . "</th>";
	echo "<th  class= 'TableGenericThArrow'> 
	      <div  class='TableGenericThRight'>"  . $this->InstanceLanguageText->GetText('REGISTER_DATE') . "</div>" .
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FORM_TICKET_LIST_FORWARD . "' 
				  id='"    . ConfigInfraTools::FORM_TICKET_LIST_FORWARD . "'
				  value='" . ConfigInfraTools::FORM_TICKET_LIST_FORWARD . "'
	...
	foreach($this->ArrayInstanceTicket as $key=>$ticket)
	{
		...
		echo "<td class='TableGenericTdLink'>
				<form  name='" . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "' method='post' />
						<input type='hidden'
							 name='"   . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "' 
							 id='"     . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "'
							 value='"  . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "' />
					  <input type='submit' name='" . ConfigInfraTools::FORM_FIELD_TICKET_ID . "' 
										   id='"   . ConfigInfraTools::FORM_FIELD_TICKET_ID . "' 
		...
		echo "<td class='TableGenericTdLink'>
				<form  name='" . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "' method='post' />
						<input type='hidden'
							 ...
							 id='"     . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "'
							 value='"  . ConfigInfraTools::FORM_TICKET_SELECT_SUBMIT . "' />
					  <input type='submit' name='" . ConfigInfraTools::FORM_FIELD_TICKET_TITLE . "' 
										   id='"   . ConfigInfraTools::FORM_FIELD_TICKET_TITLE . "' 
