...
if(is_array($this->ArrayInstanceInfraToolsService))
{
	...
	<?php
	echo "<form  name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER . "' method='" . $this->InputValueFormMethod . "' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_BACK . "' 
				  id='"    . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_BACK . "'
				  value='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_FORWARD . "' 
				  id='"    . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_FORWARD . "'
				  value='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_FORWARD . "'
	...
	foreach($this->ArrayInstanceInfraToolsService as $key=>$infraToolsService)
	{
		...
		echo "<td class='TableGenericTdLink'>
			  	<form  name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_ID . "' method='post' />
					<input type='submit' name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_ID_SUBMIT . "' 
									   id='"   . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_ID_SUBMIT . "' 
									   value='" . $infraToolsService->GetServiceId() . "' 
									   title='" . $infraToolsService->GetServiceId() . "' />
			  	</form>
		      </td>";
		echo "<td class='TableGenericTdLink'>
			  	<form  name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_NAME_AND_ID . "' method='post' />
			    	<input type='hidden' name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_ID_SUBMIT . "' 
			  					   id='"   . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_ID_SUBMIT . "' 
								   value='" . $infraToolsService->GetServiceId() . "' />
								   
		      		<input type='submit' name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_TYPE_SELECT_BY_NAME_AND_ID_SUBMIT . "' 
		                           id='"   . ConfigInfraTools::FORM_SERVICE_LIST_BY_USER_SELECT_BY_NAME_AND_ID_SUBMIT . "' 
