...
if(is_array($this->ArrayInstanceInfraToolsService))
{
	...
	<?php
	echo "<form  name='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER . "' method='" . $this->InputValueFormMethod . "' />";
	...
	echo "<th class='TableGenericThArrow'>" .
		 "<div class='TableGenericInputLeft'>
		  <input  type='image'
				  ...
				  name='"  . ConfigInfraTools::FM_SERVICE_LST_BY_USER_BACK . "' 
				  id='"    . ConfigInfraTools::FM_SERVICE_LST_BY_USER_BACK . "'
				  value='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER_BACK . "'
	...
	echo "<th  class= 'TableGenericThArrow'> 
		 ...
		 "<div class='TableGenericInputRight'>
		          <input  type='image'
				  class='TableGenericThArrowImage'
				  name='"  . ConfigInfraTools::FM_SERVICE_LST_BY_USER_FORWARD . "' 
				  id='"    . ConfigInfraTools::FM_SERVICE_LST_BY_USER_FORWARD . "'
				  value='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER_FORWARD . "'
	...
	foreach($this->ArrayInstanceInfraToolsService as $key=>$infraToolsService)
	{
		...
		echo "<td class='TableGenericTdLink'>
			  	<form  name='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_ID . "' method='post' />
					<input type='submit' name='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_ID_SB . "' 
									   id='"   . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_ID_SB . "' 
									   value='" . $infraToolsService->GetServiceId() . "' 
									   title='" . $infraToolsService->GetServiceId() . "' />
			  	</form>
		      </td>";
		echo "<td class='TableGenericTdLink'>
			  	<form  name='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_NAME_AND_ID . "' method='post' />
			    	<input type='hidden' name='" . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_ID_SB . "' 
			  					   id='"   . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_ID_SB . "' 
								   value='" . $infraToolsService->GetServiceId() . "' />
								   
		      		<input type='submit' name='" . ConfigInfraTools::FM_SERVICE_LST_BY_TYPE_SEL_BY_NAME_AND_ID_SB . "' 
		                           id='"   . ConfigInfraTools::FM_SERVICE_LST_BY_USER_SEL_BY_NAME_AND_ID_SB . "' 
