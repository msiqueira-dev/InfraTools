...
<!-- TYPE SERVICE -->
 <div class="DivContentBodyContainer">
	...
	<div class="DivContentBodyContainerValue">
		<form name='<?php echo ConfigInfraTools::FORM_SERVICE_LIST_BY_TYPE_SERVICE_SELECT_TYPE_SERVICE; ?>' method="GET">
			<select 
...
if(is_array($this->ArrayInfraToolsService) && (count($this->ArrayInfraToolsService)>0))
{
	...
	<?php
	echo "<form  name='" . ConfigInfraTools::FORM_SERVICE_LIST_BY_TYPE_SERVICE . "' method='get' />";
