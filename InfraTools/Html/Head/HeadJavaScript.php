...
";
echo "</script>";
if($this->Page == ConfigInfraTools::PAGE_REGISTER            || $this->Page == ConfigInfraTools::PAGE_ADMIN_USER_UPDATE || 
   $this->Page == ConfigInfraTools::PAGE_ADMIN_USER_REGISTER || $this->Page == ConfigInfraTools::PAGE_ACCOUNT_UPDATE)
{
	echo "<script 
