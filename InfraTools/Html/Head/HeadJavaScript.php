...
";
echo "</script>";
if($this->Page == ConfigInfraTools::PAGE_REGISTER                || $this->PageBody == ConfigInfraTools::PAGE_ADMIN_USER_UPDATE || 
   $this->PageBody == ConfigInfraTools::PAGE_ADMIN_USER_REGISTER || $this->PageBody == ConfigInfraTools::PAGE_ACCOUNT_UPDATE)
{
	echo "<script 
