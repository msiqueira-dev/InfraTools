...
{	
	...
	const DB_ERROR_NETWORK_SEL_BY_IP_ADDRESS                                    = "DbErrorNetworkSelByIpAddress";
	const DB_ERROR_NETWORK_SEL_BY_IP_ADDRESS_FETCH                              = "DbErrorNetworkSelByIpAddressFetch";
	...
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS                                         = "FmIpAddressViewIpAddress";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_DEL                                     = "FmIpAddressViewIpAddressDelete";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_DEL_SB                                  = "FmIpAddressViewIpAddressDeleteSb";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_LST_USERS                               = "FmIpAddressViewIpAddressListUsers";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_LST_USERS_FORM                          = "FmIpAddressViewIpAddressListUsersFm";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_LST_USERS_SB                            = "FmIpAddressViewIpAddressListUsersSb";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_LST_USERS_SB_BACK                       = "FmIpAddressViewIpAddressListUsersSbBack";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_LST_USERS_SB_FORWARD                    = "FmIpAddressViewIpAddressListUsersSbForward";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_UPDT                                    = "FmIpAddressViewIpAddressUpdate";
	const FM_IP_ADDRESS_VIEW_IP_ADDRESS_UPDT_SB                                 = "FmIpAddressViewIpAddressUpdateSb";
	const FM_IP_ADDRESS_VIEW_NETWORK                                            = "FmIpAddressViewNetwork";
	const FM_IP_ADDRESS_VIEW_NETWORK_DEL                                        = "FmIpAddressViewNetworkDelete";
	const FM_IP_ADDRESS_VIEW_NETWORK_DEL_SB                                     = "FmIpAddressViewNetworkDeleteSb";
	const FM_IP_ADDRESS_VIEW_NETWORK_LST_USERS                                  = "FmIpAddressViewNetworkListUsers";
	const FM_IP_ADDRESS_VIEW_NETWORK_LST_USERS_FORM                             = "FmIpAddressViewNetworkListUsersFm";
	const FM_IP_ADDRESS_VIEW_NETWORK_LST_USERS_SB                               = "FmIpAddressViewNetworkListUsersSb";
	const FM_IP_ADDRESS_VIEW_NETWORK_LST_USERS_SB_BACK                          = "FmIpAddressViewNetworkListUsersSbBack";
	const FM_IP_ADDRESS_VIEW_NETWORK_LST_USERS_SB_FORWARD                       = "FmIpAddressViewNetworkListUsersSbForward";
	const FM_IP_ADDRESS_VIEW_NETWORK_UPDT                                       = "FmIpAddressViewNetworkUpdate";
	const FM_IP_ADDRESS_VIEW_NETWORK_UPDT_SB                                    = "FmIpAddressViewNetworkUpdateSb";
	...
	const FM_TYPE_SERVICE_LST_FORM                                              = "FmTypeServiceListForm";
	...
	const FM_TYPE_SERVICE_REGISTER_FORM                                         = "FmTypeServiceRegisterForm";
	...
	const FM_TYPE_SERVICE_UPDT_FORM                                             = "FmTypeServiceUpdateForm";
	const FM_TYPE_SERVICE_UPDT_SB                                               = "FmTypeServiceUpdateSb";
	const FM_TYPE_SERVICE_VIEW                                                  = "FmTypeServiceView";
	const FM_TYPE_SERVICE_VIEW_LST_USERS                                        = "FmTypeServiceViewListServices";
	const FM_TYPE_SERVICE_VIEW_LST_USERS_FORM                                   = "FmTypeServiceViewListServiceForm";
	const FM_TYPE_SERVICE_VIEW_LST_USERS_SB                                     = "FmTypeServiceViewListServiceSb";
	const FM_TYPE_SERVICE_VIEW_LST_USERS_SB_BACK                                = "FmTypeServiceViewListServiceSbBack";
	const FM_TYPE_SERVICE_VIEW_LST_USERS_SB_FORWARD                             = "FmTypeServiceViewListServiceSbForward";
	...
	const FM_TYPE_SERVICE_VIEW_DEL                                              = "FmTypeServiceViewDelete";
	const FM_TYPE_SERVICE_VIEW_DEL_SB                                           = "FmTypeServiceViewDeleteSb";
	const FM_TYPE_SERVICE_VIEW_UPDT                                             = "FmTypeServiceViewUpdate";
	...
	const PAGE_ADMIN_IP_ADDRESS_UPDT_IP_ADDRESS                                 = "Page_Admin_Ip_Address_Update_Ip_Address";
	const PAGE_ADMIN_IP_ADDRESS_UPDT_NETWORK                                    = "Page_Admin_Ip_Address_Update_Network";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_IP_ADDRESS                                 = "Page_Admin_Ip_Address_View_Ip_Address";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_NETWORK                                    = "Page_Admin_Ip_Address_View_Network";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_USERS_IP_ADDRESS                           = "Page_Admin_Ip_Address_View_UsersIpAddress";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_USERS_NETWORK                              = "Page_Admin_Ip_Address_View_UsersNetwork";
