...
{	
	...
	const DB_ERROR_ASSOC_USER_SERVICE_DEL_BY_ASSOC_USER_SERVICE_ID_AND_EMAIL    = "RetMySqlAssocUserServiceDeleteByAssocUserServiceIdAndEmail";
	const DB_ERROR_ASSOC_USER_SERVICE_INSERT                                    = "DbErrorAssocUserServiceInsert";
	const DB_ERROR_ASSOC_USER_SERVICE_SEL_BY_ASSOC_USER_SERVICE_ID              = "RetMySqlAssocUserServiceSelByAssocUserServiceId";
	const DB_ERROR_ASSOC_USER_SERVICE_SEL_BY_ASSOC_USER_SERVICE_ID_FETCH        = "RetMySqlAssocUserServiceSelByAssocUserServiceIdFetch";
	const DB_ERROR_IP_ADDRESS_DEL_BY_IP_ADDRESS_IPV4                            = "RetMySqlIpAddressDeleteByIpAddressIpv4";
	const DB_ERROR_IP_ADDRESS_INSERT                                            = "RetMySqlIpAddressInsert";
	const DB_ERROR_IP_ADDRESS_SEL                                               = "RetMySqlIpAddressSelect";
	const DB_ERROR_IP_ADDRESS_SEL_BY_IP_ADDRESS_IPV4                            = "RetMySqlIpAddressSelByIpAddressIpv4";
	const DB_ERROR_IP_ADDRESS_SEL_BY_IP_ADDRESS_IPV4_FETCH                      = "RetMySqlIpAddressSelByIpAddressIpv4Fetch";
	const DB_ERROR_IP_ADDRESS_SEL_BY_IP_ADDRESS_IPV6                            = "RetMySqlIpAddressSelByIpAddressIpv6";
	const DB_ERROR_IP_ADDRESS_SEL_BY_IP_ADDRESS_IPV6_FETCH                      = "RetMySqlIpAddressSelByIpAddressIpv6Fetch";
	const DB_ERROR_IP_ADDRESS_SEL_FETCH                                         = "RetMySqlIpAddressSelFetch";
	const DB_ERROR_IP_ADDRESS_UPDT_BY_IP_ADDRESS_IPV4                           = "RetMySqlIpAddressUpdateByIpAddressIpv4";
	const DB_ERROR_IP_ADDRESS_UPDT_BY_IP_ADDRESS_IPV6                           = "RetMySqlIpAddressUpdateByIpAddressIpv6";
	const DB_ERROR_NETWORK_DEL_BY_NETWORK_NAME                                  = "RetNetworkDeleteByNetworkName";
	const DB_ERROR_NETWORK_INSERT                                               = "RetMySqlNetworkInsert";
	const DB_ERROR_NETWORK_SEL                                                  = "RetMySqlNetworkSel";
	const DB_ERROR_NETWORK_SEL_BY_NETWORK_IP                                    = "RetMySqlNetworkSelByNetworkIp";
	const DB_ERROR_NETWORK_SEL_BY_NETWORK_IP_FETCH                              = "RetMySqlNetworkSelByNetworkIpFetch";
	const DB_ERROR_NETWORK_SEL_BY_NETWORK_NAME                                  = "RetMySqlNetworkSelByNetworkName";
	const DB_ERROR_NETWORK_SEL_BY_NETWORK_NAME_FETCH                            = "RetMySqlNetworkSelByNetworkNameFetch";
	const DB_ERROR_NETWORK_SEL_BY_NETWORK_NETMASK                               = "RetMySqlNetworkSelByNetworkNetmask";
	const DB_ERROR_NETWORK_SEL_BY_NETWORK_NETMASK_FETCH                         = "RetMySqlNetworkSelByNetworkNetmaskFetch";
	const DB_ERROR_NETWORK_SEL_FETCH                                            = "RetMySqlNetworkSelFetch";
	const DB_ERROR_NETWORK_UPDT_BY_NETWORK_NAME                                 = "RetMySqlNetworkUpdateByNetworkName";
	const DB_ERROR_SERVICE_DEL_BY_SERVICE_ID                                    = "RetMySqlServiceDeleteByServiceId";
	const DB_ERROR_SERVICE_INSERT                                               = "RetMySqlServiceInsert";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_ACTIVE                                = "RetMySqlServiceSelByServiceActive";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_ACTIVE_FETCH                          = "RetMySqlServiceSelByServiceActiveFetch";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_CORPORATION                           = "RetMySqlServiceSelByServiceCorporation";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_CORPORATION_FETCH                     = "RetMySqlServiceSelByServiceCorporationFetch";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_DEPARTMENT                            = "RetMySqlServiceSelByServiceDepartment";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_DEPARTMENT_FETCH                      = "RetMySqlServiceSelByServiceDepartmentFetch";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_ID                                    = "RetMySqlServiceSelByServiceId";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_NAME                                  = "RetMySqlServiceSelByServiceName";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_NAME_FETCH                            = "RetMySqlServiceSelByServiceNameFetch";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_TYPE                                  = "RetMySqlServiceSelByServiceType";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_TYPE_FETCH                            = "RetMySqlServiceSelByServiceTypeFetch";
	const DB_ERROR_SERVICE_SEL_BY_TYPE_ASSOC_USER_SERVICE                       = "RetMySqlServiceSelByTypeAssocUserService";
	const DB_ERROR_SERVICE_SEL_BY_TYPE_ASSOC_USER_SERVICE_FETCH                 = "RetMySqlServiceSelByTypeAssocUserServiceFetch";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_USER                                  = "RetMySqlServiceSelByServiceUser";
	const DB_ERROR_SERVICE_SEL_BY_SERVICE_USER_FETCH                            = "RetMySqlServiceSelByServiceUserFetch";
	const DB_ERROR_SERVICE_SEL                                                  = "RetMySqlServiceSel";
	const DB_ERROR_SERVICE_SEL_FETCH                                            = "RetMySqlServiceSelFetch";
	const DB_ERROR_SERVICE_UPDT_BY_SERVICE_ID                                   = "RetMySqlServiceUpdateByServiceId";
	const DB_ERROR_SERVICE_UPDT_RESTRICT_BY_SERVICE_ID                          = "RetMySqlServiceUpdateRestrictByServiceId";
	const DB_ERROR_TYPE_ASSOC_USER_SERVICE_SEL                                  = "RetMySqlTypeAssocUserServiceSel";
	const DB_ERROR_TYPE_ASSOC_USER_SERVICE_SEL_FETCH                            = "RetMySqlTypeAssocUserServiceSelFetch";
	const DB_ERROR_TYPE_SERVICE_SEL                                             = "RetMySqlTypeServiceSel";
	const DB_ERROR_TYPE_SERVICE_SEL_FETCH                                       = "RetMySqlTypeServiceSelFetch";
