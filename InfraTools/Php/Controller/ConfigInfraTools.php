...
{	
	...
	const FORM_FIELD_NETWORK_IP                                         = "NetworkIp";
	const FORM_FIELD_NETWORK_NAME                                       = "FormFieldNetworkName";
	const FORM_FIELD_NETWORK_NETMASK                                    = "FormFieldNetworkNetmask";
	...
	const MYSQL_NETWORK_DELETE_BY_NETWORK_NAME_FAILED                   = "RetNetworkDeleteByNetworkNameFailed";
	const MYSQL_NETWORK_DELETE_BY_NETWORK_NAME_FAILED_NOT_FOUND         = "RetNetworkDeleteByNetworkNameFailedNotFound";
	const MYSQL_NETWORK_INSERT_FAILED                                   = "RetMySqlNetworkInsertFailed";
	const MYSQL_NETWORK_SELECT_FAILED                                   = "RetMySqlNetworkSelectFailed";
	const MYSQL_NETWORK_SELECT_BY_NETWORK_IP_FAILED                     = "RetMySqlNetworkSelectByNetworkIpFailed";
	const MYSQL_NETWORK_SELECT_BY_NETWORK_IP_FETCH_FAILED               = "RetMySqlNetworkSelectByNetworkIpFetchFailed";
	const MYSQL_NETWORK_SELECT_BY_NETWORK_NAME_FAILED                   = "RetMySqlNetworkSelectByNetworkNameFailed";
	const MYSQL_NETWORK_SELECT_BY_NETWORK_NAME_FETCH_FAILED             = "RetMySqlNetworkSelectByNetworkNameFetchFailed";
	const MYSQL_NETWORK_SELECT_BY_NETWORK_NETMASK_FAILED                = "RetMySqlNetworkSelectByNetworkNetmaskFailed";
	const MYSQL_NETWORK_SELECT_BY_NETWORK_NETMASK_FETCH_FAILED          = "RetMySqlNetworkSelectByNetworkNetmaskFetchFailed";
	const MYSQL_NETWORK_SELECT_FETCH_FAILED                             = "RetMySqlNetworkSelectFetchFailed";
	const MYSQL_NETWORK_UPDATE_BY_NETWORK_NAME_FAILED                   = "RetMySqlNetworkUpdateByNetworkNameFailed";
	...
	const TABLE_NETWORK_FIELD_NETWORK_IP                                = "NetworkIp";
	const TABLE_NETWORK_FIELD_NETWORK_NAME                              = "NetworkName";
	const TABLE_NETWORK_FIELD_NETWORK_NETMASK                           = "NetworkNetmask";
	...
	const TABLE_TYPE_STATUS_MONITORING                                  = "TYPE_STATUS_MONITORING";
	const TABLE_TYPE_STATUS_MONITORING_FIELD_DESCRIPTION                = "TypeStatusMonitoringDescription";
