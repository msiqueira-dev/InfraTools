...
class Es
{
	...
	const FORM_FIELD_ROLE_DESCRIPTION                               = "";
	...
	const IP_ADDRESS_DELETE_ERROR                                   = "";
	const IP_ADDRESS_DELETE_ERROR_DEPENDENCY_SERVICE                = "";
	const IP_ADDRESS_DELETE_SUCCESS                                 = "";
	...
	const PAGE_ADMIN_IP_ADDRESS_LIST                                = "";
	const PAGE_ADMIN_IP_ADDRESS_LIST_ROBOTS                         = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_LIST_TITLE                          = "InfraTools -";
	...
	const PAGE_ADMIN_IP_ADDRESS_SELECT                              = "";
	const PAGE_ADMIN_IP_ADDRESS_SELECT_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_SELECT_TITLE                        = "InfraTools -";
	const PAGE_ADMIN_IP_ADDRESS_TITLE                               = "InfraTools -";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE                              = "";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE_TITLE                        = "InfraTools -";
	...
	const PAGE_ADMIN_ROLE_LIST                                      = "";
	const PAGE_ADMIN_ROLE_LIST_ROBOTS                               = "noindex";
	const PAGE_ADMIN_ROLE_LIST_TITLE                                = "InfraTools -";
	...
	const PAGE_ADMIN_ROLE_SELECT                                    = "";
	const PAGE_ADMIN_ROLE_SELECT_ROBOTS                             = "noindex";
	const PAGE_ADMIN_ROLE_SELECT_TITLE                              = "InfraTools -";
	const PAGE_ADMIN_ROLE_TITLE                                     = "InfraTools -";
	const PAGE_ADMIN_ROLE_UPDATE                                    = "";
	const PAGE_ADMIN_ROLE_UPDATE_ROBOTS                             = "noindex";
	const PAGE_ADMIN_ROLE_UPDATE_TITLE                              = "InfraTools -";
	...
	const USER_SELECT_BY_IP_ADDRESS_IPV4_ERROR                      = "";
	const USER_SELECT_BY_IP_ADDRESS_IPV4_WARNING                    = "";
	const USER_SELECT_BY_NOTIFICATION_ID_ERROR                      = "";
	const USER_SELECT_BY_NOTIFICATION_ID_WARNING                    = "";
	const USER_SELECT_BY_ROLE_NAME_ERROR                            = "";
	const USER_SELECT_BY_ROLE_NAME_WARNING                          = "";
