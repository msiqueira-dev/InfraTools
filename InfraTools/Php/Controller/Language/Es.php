...
class Es
{
	...
	const HREF_PAGE_ADMIN_NOTIFICATION                              = "/Es/PageAdminNotification";
	const HREF_PAGE_ADMIN_SERVICE                                   = "/Es/PageAdminService";
	const HREF_PAGE_ADMIN_SYSTEM_CONFIGURATION                      = "/Es/PageAdminSystemConfiguration";
	...
	const HREF_PAGE_TEAM_LIST                                       = "/Es/PageTeamList";
	const HREF_PAGE_TEAM_REGISTER                                   = "/Es/PageTeamRegister";
	const HREF_PAGE_TEAM_SELECT                                     = "/Es/PageTeamSelect";
	const HREF_PAGE_TEAM_VIEW                                       = "/Es/PageTeamView";
	const ID                                                        = "";
