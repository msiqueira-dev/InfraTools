...
class De
{
	...
	const PAGE_ADMIN_IP_ADDRESS_UPDT                              = "";
	const PAGE_ADMIN_IP_ADDRESS_UPDT_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_UPDT_TITLE                        = "InfraTools -";
	const PAGE_ADMIN_IP_ADDRESS_VIEW                                = "";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_ROBOTS                         = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_TITLE                          = "InfraTools -";
	...
	const USER_DEL_FAILED_RESTRICTION                            = "";
	const USER_INACTIVE                                             = "";
	...
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE                         = "";
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE_DAY                     = "";
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE_MONTH                   = "";
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE_YEAR                    = "";
	const ACCOUNT_UPDT_INVALID_GENDER                             = "";
	const ACCOUNT_UPDT_INVALID_NAME                               = "";
	const ACCOUNT_UPDT_INVALID_NAME_SIZE                          = "";
	const ACCOUNT_UPDT_INVALID_USER_UNIQUE_ID                     = "";
	const ACCOUNT_UPDT_INVALID_USER_UNIQUE_ID_SIZE                = "";
	const ACCOUNT_UPDT_NAME_TIP                                   = "";
	const ACCOUNT_UPDT_SEL_BIRTH_DATE_DAY                      = "";
	const ACCOUNT_UPDT_SEL_BIRTH_DATE_MONTH                    = "";
	const ACCOUNT_UPDT_SEL_BIRTH_DATE_YEAR                     = "";
	const FIELD_USER_GENDER_MALE                         = "";
	const FIELD_USER_GENDER_FEMALE                       = "";
	const ACCOUNT_UPDT_TEXT_BIRTH_DATE                            = "";
	...
	const ACCOUNT_CHANGE_PASSWORD_SB                            = "";
	const ACCOUNT_CHANGE_PASSWORD_SB_CANCEL                     = "";
	...
	const REGISTER_CONFIRMATION_UPDT_ERROR                        = "";
