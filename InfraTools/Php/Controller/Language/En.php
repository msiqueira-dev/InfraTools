...
class En
{
	...
	const ASSOC_USER_CORPORATION_UPDATE_ERROR                       = "Error updating corporation information";
	...
	const FORM_FIELD_ASSOC_USER_CORPORATION_REGISTRATION_DATE       = "Registration date";
	const FORM_FIELD_ASSOC_USER_CORPORATION_REGISTRATION_ID         = "Registration ID";
	const FORM_FIELD_CORPORATION_ACTIVE                             = "Active";
	const FORM_FIELD_CORPORATION_NAME                               = "Corporation name";
	const FORM_FIELD_COUNTRY_ABBREVIATION                           = "Country Initials";
	const FORM_FIELD_COUNTRY_NAME                                   = "Country";
	...
	const FORM_FIELD_NETWORK_IP                                     = "Network Ip";
	const FORM_FIELD_NETWORK_NAME                                   = "Network Name";
	const FORM_FIELD_NETWORK_NETMASK                                = "Network Netmask";
	const FORM_FIELD_NOTIFICATION_ACTIVE                            = "Active";
	const FORM_FIELD_NOTIFICATION_ID                                = "Id";
	const FORM_FIELD_NOTIFICATION_TEXT                              = "Text";
	const FORM_FIELD_ROLE_DESCRIPTION                               = "Description";
	const FORM_FIELD_RADIO_DEPARTMENT_NAME_AND_CORPORATION_NAME     = "Department name and corporation name";
	...
	const FORM_FIELD_TYPE_ASSOC_USER_TEAM_DESCRIPTION               = "Description";
	const FORM_FIELD_TYPE_SERVICE_NAME                              = "Type service";
	const FORM_FIELD_TYPE_USER_DESCRIPTION                          = "Description";
	const FORM_FIELD_USER_ACTIVE                                    = "Account active";
	const FORM_FIELD_USER_CONFIRMED                                 = "Account confirmed";
	const FORM_FIELD_USER_EMAIL                                     = "E-mail";
	const FORM_FIELD_USER_GENDER                                    = "Gender";
	const FORM_FIELD_USER_NAME                                      = "Name";
	const FORM_FIELD_USER_PHONE_PRIMARY                             = "Phone Primary";
	const FORM_FIELD_USER_PHONE_SECONDARY                           = "Phone Secondary";
	const FORM_FIELD_USER_REGION                                    = "Location";
	const FORM_FIELD_USER_SESSION_EXPIRES                           = "Session Expires";
	const FORM_FIELD_USER_TYPE                                      = "Type";
	const FORM_FIELD_USER_TWO_STEP_VERIFICATION                     = "Two step verification";
	const FORM_FIELD_USER_UNIQUE_ID                                 = "Unique ID";
	...
	const FORM_INVALID_IP_ADDRESS_IPV4                              = "Invalid value for ipv4";
	const FORM_INVALID_IP_ADDRESS_IPV6                              = "Invalid value for ipv6";
	...
	const FORM_INVALID_NOTIFICATION_TEXT_SIZE                       = "Quantity of characters exceeds the maximum allowed for notification "
	                                                                . "text";
	const FORM_INVALID_ROLE_DESCRIPTION                             = "Invalid role description";
	const FORM_INVALID_ROLE_DESCRIPTION_SIZE                        = "Quantity of characters exceeds the maximum allowed for role description";
	...
	const FORM_INVALID_SERVICE_DESCRIPTION                          = "Invalid service description";
	...
	const FORM_INVALID_SERVICE_TYPE_SIZE                            = "Quantity of characters exceeds the maximum allowed for service "
		                                                            . "description";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_ACTIVE           = "Invalid value for checkbox option active service";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_DESCRIPTION      = "Invalid value for system configuration option description";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_DESCRIPTION_SIZE = "Quantity of characters exceeds the maximum allowed for system "
	                                                                . "configuration option description";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_NAME             = "Invalid value for system configuration option name";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_NAME_SIZE        = "Quantity of characters exceeds the maximum allowed for system "
	                                                                . "configuration option name";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_VALUE            = "Invalid value for system configuration option value";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_VALUE_SIZE       = "Quantity of characters exceeds the maximum allowed for system "
	...
	const HREF_PAGE_TEAM_LIST                                       = "/En/PageTeamList";
	const HREF_PAGE_TEAM_REGISTER                                   = "/En/PageTeamRegister";
	const HREF_PAGE_TEAM_SELECT                                     = "/En/PageTeamSelect";
	...
	const IP_ADDRESS_DELETE_ERROR                                   = "Error deleting ip address";
	const IP_ADDRESS_DELETE_ERROR_DEPENDENCY_SERVICE                = "Ip address has services associated, delete them first";
	const IP_ADDRESS_DELETE_SUCCESS                                 = "Ip address deleted succesfully";
	...
	const IP_ADDRESS_SELECT_BY_IP_ADDRESS_IPV4_ERROR                = "Error trying to obtain ip address with given ipv4";
	const IP_ADDRESS_SELECT_BY_IP_ADDRESS_IPV4_SUCCESS              = "Ip Address obtained successfully";
	const IP_ADDRESS_SELECT_BY_IP_ADDRESS_IPV6_ERROR                = "Error trying to obtain ip address with given ipv6";
	const IP_ADDRESS_SELECT_BY_IP_ADDRESS_IPV6_SUCCESS              = "Ip Address obtained successfully";
	const IP_ADDRESS_UPDATE_ERROR                                   = "Error updating ip address";
	const IP_ADDRESS_UPDATE_ERROR_UNIQUE_EXISTS                     = "A ip address with the same value exists";
	const IP_ADDRESS_UPDATE_SUCCESS                                 = "Ip address updated successfully";
	...
	const PAGE_ADMIN_IP_ADDRESS_LIST                                = "Admin Ip Address - List";
	const PAGE_ADMIN_IP_ADDRESS_LIST_ROBOTS                         = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_LIST_TITLE                          = "InfraTools - Admin Ip Address";
	...
	const PAGE_ADMIN_IP_ADDRESS_SELECT                              = "Admin Ip Address - Select";
	const PAGE_ADMIN_IP_ADDRESS_SELECT_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_SELECT_TITLE                        = "InfraTools - Admin Ip Address";
	const PAGE_ADMIN_IP_ADDRESS_TITLE                               = "InfraTools - Admin Ip Address";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE                              = "Admin Ip Address - Update";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE_TITLE                        = "InfraTools - Admin Ip Address";
	const PAGE_ADMIN_IP_ADDRESS_VIEW                                = "Admin Ip Address - View";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_ROBOTS                         = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_VIEW_TITLE                          = "InfraTools - Admin Ip Address";
	...
	const PAGE_ADMIN_ROLE_LIST                                      = "Admin User's Role - List";
	const PAGE_ADMIN_ROLE_LIST_ROBOTS                               = "noindex";
	const PAGE_ADMIN_ROLE_LIST_TITLE                                = "InfraTools - Admin User's Role";
	...
	const PAGE_ADMIN_ROLE_SELECT                                    = "Admin User's Role - Select";
	const PAGE_ADMIN_ROLE_SELECT_ROBOTS                             = "noindex";
	const PAGE_ADMIN_ROLE_SELECT_TITLE                              = "InfraTools - Admin User's Role";
	const PAGE_ADMIN_ROLE_TITLE                                     = "InfraTools - Admin User's Role";
	const PAGE_ADMIN_ROLE_UPDATE                                    = "Admin User's Role - Update";
	const PAGE_ADMIN_ROLE_UPDATE_ROBOTS                             = "noindex";
	const PAGE_ADMIN_ROLE_UPDATE_TITLE                              = "InfraTools - Admin User's Role";
	...
	const PAGE_ADMIN_SERVICE_SELECT                                 = "Admin Service - Select";
	...
	const PAGE_ADMIN_SERVICE_UPDATE                                 = "Admin Service - Update";
	...
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_LIST                      = "Admin System Configuration - List";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_LIST_ROBOTS               = "noindex";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_LIST_TITLE                = "InfraTools - Admin System Configuration";
	...
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_SELECT                    = "Admin System Configuration - Select";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_SELECT_ROBOTS             = "noindex";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_SELECT_TITLE              = "InfraTools - Admin System Configuration";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_TITLE                     = "InfraTools - Admin System Configuration";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_UPDATE                    = "Admin System Configuration - Update";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_UPDATE_ROBOTS             = "noindex";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_UPDATE_TITLE              = "InfraTools - Admin System Configuration";
	...
	const PAGE_TEAM_LIST                                            = "Team List";
	const PAGE_TEAM_LIST_ROBOTS                                     = "noindex";
	const PAGE_TEAM_LIST_TITLE                                      = "InfraTools - Team List";
	...
	const PAGE_TEAM_SELECT                                          = "Team Select";
	const PAGE_TEAM_SELECT_ROBOTS                                   = "noindex";
	const PAGE_TEAM_SELECT_TITLE                                    = "InfraTools - Team Select";
	const PAGE_TEAM_UPDATE                                          = "Team Update";
	const PAGE_TEAM_UPDATE_ROBOTS                                   = "noindex";
	const PAGE_TEAM_UPDATE_TITLE                                    = "InfraTools - Team Update";
	...
	const SERVICE_SELECT_BY_SERVICE_TYPE_ASSOC_USER_SERVICE_ERROR   = "Service was found";
	const SERVICE_SELECT_BY_SERVICE_TYPE_ASSOC_USER_SERVICE_SUCCESS = "No service was found";
	...
	const SYSTEM_CONFIGURATION_UPDATE_SUCCESS                       = "System configuration updated successfully";
	...
	const USER_SELECT_BY_IP_ADDRESS_IPV4_ERROR                      = "Error trying to obtain users associated with this ip address";
	const USER_SELECT_BY_IP_ADDRESS_IPV4_WARNING                    = "No user is associated with this ip address";
	const USER_SELECT_BY_NOTIFICATION_ID_ERROR                      = "Error trying to obtain users associated with this notification";
	const USER_SELECT_BY_NOTIFICATION_ID_WARNING                    = "No user is associated with this notification";
	const USER_SELECT_BY_ROLE_NAME_ERROR                            = "Error trying to obtain users associated with this role";
	const USER_SELECT_BY_ROLE_NAME_WARNING                          = "No user is associated with this role";
