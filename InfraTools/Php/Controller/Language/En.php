...
class En
{
	...
	const PAGE_ADMIN_IP_ADDRESS_UPDT                              = "Admin Ip Address - Update";
	const PAGE_ADMIN_IP_ADDRESS_UPDT_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_UPDT_TITLE                        = "InfraTools - Admin Ip Address";
	...
	const USER_DEL_FAILED_RESTRICTION                            = "There are associations to this user, please delete them " 
	                                                                . "first";
	...
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE                      = "Invalid birth date";
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE_DAY                  = "Invalid birth day";
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE_MONTH                = "Invalid birth month";
	const ACCOUNT_UPDT_INVALID_BIRTH_DATE_YEAR                 = "Invalid birth year";
	const ACCOUNT_UPDT_INVALID_GENDER                          = "Invalid gender, chose a valid gender from the given list";
	const ACCOUNT_UPDT_INVALID_NAME                            = "Please fill a valid name";
	const ACCOUNT_UPDT_INVALID_NAME_SIZE                       = "Quantity of characters exceeds the maximum allowed on name";
	const ACCOUNT_UPDT_INVALID_USER_UNIQUE_ID                  = "Please fill a valid unique ID";
	const ACCOUNT_UPDT_INVALID_USER_UNIQUE_ID_SIZE             = "Quantity of characters exceeds the maximum allowed on "
		                                                         . "unique ID";
	const ACCOUNT_UPDT_NAME_TIP                                = "(Name and surname)";
	const ACCOUNT_UPDT_SEL_BIRTH_DATE_DAY                   = "Day";
	const ACCOUNT_UPDT_SEL_BIRTH_DATE_MONTH                 = "Month";
	const ACCOUNT_UPDT_SEL_BIRTH_DATE_YEAR                  = "Year";
	const FIELD_USER_GENDER_MALE                            = "Male";
	const FIELD_USER_GENDER_FEMALE                          = "Female";
	const ACCOUNT_UPDT_TEXT_BIRTH_DATE                         = "Birth Date";
	...
	const ACCOUNT_CHANGE_PASSWORD_REPEAT_PASSWORD_TITLE          = "The password must have at least 1 number and 1 capital letter, "
	                                                             . "having between 8 and 18 digits";
	const ACCOUNT_CHANGE_PASSWORD_SB                         = "UPDATE";
	const ACCOUNT_CHANGE_PASSWORD_SB_CANCEL                  = "CANCEL";
	...
	const REGISTER_CONFIRMATION_UPDT_ERROR                     = "Error trying to activate account";
