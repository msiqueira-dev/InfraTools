...
class Pt
{
	...
	const FORM_FIELD_ROLE_DESCRIPTION                               = "Descrição";
	...
	const FORM_INVALID_ROLE_DESCRIPTION                             = "Descrição de papel inválida";
	const FORM_INVALID_ROLE_DESCRIPTION_SIZE                        = "Quantidade de caracteres excede o tamanho máximo para descrição de "
	                                                                . " papel";
	...
	const FORM_INVALID_SERVICE_TYPE_SIZE                            = "Quantidade de caracteres excede o tamanho máximo para tipo de "
	                                                                . "serviço";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_ACTIVE           = "Campo ativo de configuração do sistema inválido";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_DESCRIPTION      = "Descrição de configuração do sistema inválida";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_DESCRIPTION_SIZE = "Quantidade de caracteres excede o tamanho máximo para descrição de "
	                                                                . "configuração do sistema";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_NAME             = "Nome de configuração do sistema inválida";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_NAME_SIZE        = "Quantidade de caracteres excede o tamanho máximo para nome de "
	                                                                . "configuração do sistema";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_VALUE            = "Valor de configuração do sistema inválido";
	const FORM_INVALID_SYSTEM_CONFIGURATION_OPTION_VALUE_SIZE       = "Quantidade de caracteres excede o tamanho máximo para valor de "
	                                                                . "configuração do sistema";
	...
	const IP_ADDRESS_DELETE_ERROR                                   = "Erro ao excluir endereço de ip";
	const IP_ADDRESS_DELETE_ERROR_DEPENDENCY_SERVICE                = "Endereço de ip possui serviços associados, exclua-os primeiro";
	const IP_ADDRESS_DELETE_SUCCESS                                 = "Endereço de ip excluido com sucesso";
	...
	const PAGE_ADMIN_IP_ADDRESS_LIST                                = "Gerência de Endereços de Ip - Listar";
	const PAGE_ADMIN_IP_ADDRESS_LIST_ROBOTS                         = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_LIST_TITLE                          = "InfraTools - Gerência de Endereços de Ip";
	...
	const PAGE_ADMIN_IP_ADDRESS_SELECT                              = "Gerência de Endereços de Ip - Selecionar";
	const PAGE_ADMIN_IP_ADDRESS_SELECT_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_SELECT_TITLE                        = "InfraTools - Gerência de Endereços de Ip";
	const PAGE_ADMIN_IP_ADDRESS_TITLE                               = "InfraTools - Gerência de Endereços de Ip";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE                              = "Gerência de Endereços de Ip - Atualizar";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE_ROBOTS                       = "noindex";
	const PAGE_ADMIN_IP_ADDRESS_UPDATE_TITLE                        = "InfraTools - Gerência de Endereços de Ip";
	...
	const PAGE_ADMIN_ROLE_LIST                                      = "Gerência de papéis de usuários - Listar";
	const PAGE_ADMIN_ROLE_LIST_ROBOTS                               = "noindex";
	const PAGE_ADMIN_ROLE_LIST_TITLE                                = "InfraTools - Gerência de papéis de usuários";
	...
	const PAGE_ADMIN_ROLE_SELECT                                    = "Gerência de papéis de usuários - Selecionar";
	const PAGE_ADMIN_ROLE_SELECT_ROBOTS                             = "noindex";
	const PAGE_ADMIN_ROLE_SELECT_TITLE                              = "InfraTools - Gerência de papéis de usuários";
	const PAGE_ADMIN_ROLE_TITLE                                     = "InfraTools - Gerência de papéis de usuários";
	const PAGE_ADMIN_ROLE_UPDATE                                    = "Gerência de papéis de usuários - Atualizar";
	const PAGE_ADMIN_ROLE_UPDATE_ROBOTS                             = "noindex";
	const PAGE_ADMIN_ROLE_UPDATE_TITLE                              = "InfraTools - Gerência de papéis de usuários";
	...
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_LIST                      = "Gerência de configurações do sistema - Listar";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_LIST_ROBOTS               = "noindex";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_LIST_TITLE                = "InfraTools - Gerência de configurações do sistema";
	...
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_SELECT                    = "Gerência de configurações do sistema - Selecionar";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_SELECT_ROBOTS             = "noindex";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_SELECT_TITLE              = "InfraTools - Gerência de configurações do sistema";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_TITLE                     = "InfraTools - Gerência de configurações do sistema";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_UPDATE                    = "Gerência de configurações do sistema - Atualizar";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_UPDATE_ROBOTS             = "noindex";
	const PAGE_ADMIN_SYSTEM_CONFIGURATION_UPDATE_TITLE              = "InfraTools - Gerência de configurações do sistema";
	...
	const SERVICE_SELECT_BY_SERVICE_TYPE_ASSOC_USER_SERVICE_ERROR   = "Nenhum serviço encontrado";
	const SERVICE_SELECT_BY_SERVICE_TYPE_ASSOC_USER_SERVICE_SUCCESS = "Serviço encontrado";
	...
	const SYSTEM_CONFIGURATION_UPDATE_SUCCESS                       = "Configuração do sistema atualizada com sucesso";
	...
	const USER_SELECT_BY_IP_ADDRESS_IPV4_ERROR                      = "Erro ao tentar obter usuários para este endereço de ip";
	const USER_SELECT_BY_IP_ADDRESS_IPV4_WARNING                    = "Nenhum usuário encontrado para este endereço de ip";
	const USER_SELECT_BY_NOTIFICATION_ID_ERROR                      = "Erro ao tentar obter usuários para esta notificão";
	const USER_SELECT_BY_NOTIFICATION_ID_WARNING                    = "Nenhum usuário encontrado para esta notificação";
	const USER_SELECT_BY_ROLE_NAME_ERROR                            = "Erro ao tentar obter usuários para este papel";
	const USER_SELECT_BY_ROLE_NAME_WARNING                          = "Nenhum usuário encontrado para este papel";
